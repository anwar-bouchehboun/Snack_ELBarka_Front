import { ShoppingCart, Printer, History, Trash2 } from 'lucide-react';
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="flex items-center gap-4">
            <div className="bg-white px-4 py-2 rounded-lg shadow">
              ...
              <span className="font-bold text-blue-600">{storageStats.totalOrders}</span>
            </div>
            <div className="bg-white px-4 py-2 rounded-lg shadow">
              <span className="text-sm text-gray-600">Chiffre d'affaires: </span>
              <span className="font-bold text-green-600">{storageStats.totalRevenue.toFixed(2)} DH</span>
            </div>
            <div className="bg-white px-4 py-2 rounded-lg shadow">
              <span className="text-sm text-gray-600">Panier moyen: </span>
              <span className="font-bold text-purple-600">{storageStats.averageOrderValue.toFixed(2)} DH</span>
            </div>
            <button
